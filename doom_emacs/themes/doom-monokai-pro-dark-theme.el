;; doom-monokai-pro-dark-theme.el --- Port of Monokai Pro -*- lexical-binding: t; no-byte-compile: t; -*-
(require 'doom-themes)

(defgroup doom-monokai-pro-dark-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom doom-monokai-pro-dark-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line.
Can be an integer to determine the exact padding."
  :group 'doom-monokai-pro-dark-theme
  :type '(choice integer boolean))

(def-doom-theme doom-monokai-pro-dark
  ...
  ((bg         '("#000000" nil       nil          ))
   ...
   (-modeline-pad
    (when doom-monokai-pro-dark-padded-modeline
      (if (integerp doom-monokai-pro-dark-padded-modeline)
          doom-monokai-pro-dark-padded-modeline
        4))))
...
(provide 'doom-monokai-pro-dark-theme)
;;; doom-monokai-pro-dark-theme.el ends here
