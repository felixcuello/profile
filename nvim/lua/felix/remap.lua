...
vim.keymap.set("n", "<C-x>1", "<C-w>o")                                   -- Close other windows (emacs muscle memory)


----------------------------------------------------------------------------------------------------------------------
--- Configurations below have been copied from the old NVIM configuration
----------------------------------------------------------------------------------------------------------------------
...
--   vim.keymap.set("n", "<leader>e", ":Neotree toggle<CR>")                          -- NeoTree toggle
--   vim.keymap.set("n", "<leader>q", ":bw<Cr>")                                           -- Close buffer
